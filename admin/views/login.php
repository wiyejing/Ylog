...
<head>
    <meta charset="UTF-8">
    <title>欢迎您登录 Ylog内容管理系统</title>
    <base href="<?=base_url()?>" />
    <link rel="stylesheet" type="text/css" href="src/css/login.css" media="all"></head>
<body id="login-page">
    <div id="main-content">

        <div class="login-body">
            <div class="login-main pr">
                <?php echo form_open($url,'class="login-form"'); ?>
                <h3 class="welcome"> <!-- <i class="login-logo"></i> -->
                    Ylog内容管理系统
                </h3>
                <div id="itemBox" class="item-box">
                    ...
                    <div>
                        <img class="verifyimg reloadverify" alt="点击切换" src="<?php echo site_url('verify'); ?>">
                    </div>
                </div>
